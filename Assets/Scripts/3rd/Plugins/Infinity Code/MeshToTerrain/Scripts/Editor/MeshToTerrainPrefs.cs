...
public class MeshToTerrainPrefs 
{
    ...
    private readonly int[] textureSizes = { 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192 };
    private readonly string[] textureSizesS = { "32", "64", "128", "256", "512", "1024", "2048", "4096", "8192" };
#else
    private readonly int[] textureSizes = { 32, 64, 128, 256, 512, 1024, 2048, 4096 };
    private readonly string[] textureSizesS = { "32", "64", "128", "256", "512", "1024", "2048", "4096" };
#endif

    private string[] availableResolutionsStr;
    private string[] availableHeightsStr;

    public bool adjustMeshSize = true;
    ...
    {
        Process.Start("mailto:support@infinity-code.com?subject=Mesh%20to%20Terrain");
    }
    ...
    private void OnTexturesGUI()
    {
        ...
        if (showTextures) OnTextureContentGUI();
    ...
    private void OnTextureContentGUI()
    {
        ...
        else textureCaptureMode = MeshToTerrainTextureCaptureMode.raycast;
    ...
    public void Save()
    {
        ...
        SetPref("TextureResolution", textureResolution);
        ...
        SetPref("AdjustMeshSize", adjustMeshSize);
